                ...
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <form>
                            ...
                            <button  type="submit" disabled={note.title.length < 3 || note.description.length < 5} className="btn btn-lg btn-outline-primary mt-2 mb-3 me-2" onClick={handleClick}>
                                Add Note
                            </button>
                            <button type="button" disabled={note.title.length < 3}  className="btn btn-lg btn-outline-primary mt-2 mb-3 me-2" onClick={generateDescription}>
